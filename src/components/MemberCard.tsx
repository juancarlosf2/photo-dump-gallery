...
export function MemberCard({ member }: MemberCardProps) {
  return (
    <Panel className="hover:shadow-lg hover:border-accent/40 transition-all duration-300 group hover:-translate-y-1">
      <Link
        to="/profile/$userId"
        ...
        <PanelContent className="p-6">
          <div className="flex flex-col items-center text-center space-y-4">
            <UserAvatar
              ...
              name={member.name}
              size="lg"
              className="shrink-0 ring-2 ring-transparent group-hover:ring-accent/50 transition-all duration-300"
            />
