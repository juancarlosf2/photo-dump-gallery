    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="bg-surface rounded-xl border border-border overflow-hidden shadow-sm">
          <div className="aspect-video bg-gradient-to-br from-surface-secondary to-surface-secondary/50 animate-pulse relative">
          ...
          <div className="p-4 space-y-3">
            ...
            <div className="h-3 bg-surface-secondary rounded w-4/5 animate-pulse" />
